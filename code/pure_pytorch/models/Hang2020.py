...
class spatial_network(nn.Module):
    ...
    def __init__(self, bands, classes):
        ...
        self.classifier1 = Classifier(classes=classes, in_features=180000)
    
        self.conv2 = conv_module(in_channels=32, filters=64, maxpool_kernel=(2,2))
        self.attention_2 = spatial_attention(filters=64)
        self.classifier2 = Classifier(classes=classes, in_features=360000)        
    
        self.conv3 = conv_module(in_channels=64, filters=128, maxpool_kernel=(2,2))
        self.attention_3 = spatial_attention(filters=128)
        self.classifier3 = Classifier(classes=classes, in_features=720000)        
    ...
    def forward(self, x):
        ...
        x, attention = self.attention_1(x)
#         print(attention.size())
#         attention = attention.view(128, 1)
#         print(f'spatial network attention_1 attention size: {attention.size()}, x size: {x.size()} ')
        scores1 = self.classifier1(attention)
